...
- JavaScript是一门***单线程的语言，也就是说，同一个时间只能做一件事***
...
<img src="../../../学习/知识点总结/02-JavaScript/images/javaScript.assets/image-20200530100043079.png" alt="image-20200530100043079" style="zoom: 67%;" />
...
- **问题：为什么会出现上图中的情况？**
    ...
    - 模拟上图中**for循环的基本流程**
        ...
        - <img src="../../../学习/知识点总结/02-JavaScript/images/javaScript.assets/image-20200629141523986.png" alt="image-20200629141523986" style="zoom:50%;" />
...
- **问题：为什么使用let声明变量可以解决问题？**
    ...
    - 模拟for循环中使用let初始化变量的流程：
        ...
        - <img src="../../../学习/知识点总结/02-JavaScript/images/javaScript.assets/image-20200629141741698.png" alt="image-20200629141741698" style="zoom:50%;" />
